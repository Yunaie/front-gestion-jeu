...
@Component({
  selector: 'app-afficher-jeu-achat',
  standalone: true,
  imports: [],
  templateUrl: './afficher-jeu-achat.component.html',
  styleUrl: './afficher-jeu-achat.component.css'
})
export class AfficherJeuAchatComponent {
